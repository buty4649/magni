...
#ifndef MAGNI_RUBY_ENTRY_POINT
#define MAGNI_RUBY_ENTRY_POINT "__main__"
#endif
...
int main(int argc, char *argv[])
{
    ...
    mrb_funcall(mrb, mrb_top_self(mrb), MAGNI_RUBY_ENTRY_POINT, 1, mrb_argv);
